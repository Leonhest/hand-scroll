...
Screenshots are illustrations generated by `assets/screenshots/make.py` (hands are
drawn as the 21-point MediaPipe skeleton the extension tracks). Edit the script and
